...
public class Logsreports {
	@Test
	public void logsreports() throws InterruptedException {
		 Logger logger = Logger.getLogger(Logsreports.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a//span[text()='Logs Reports']")).click();
			driver.findElement(By.xpath("//ul//li//a//span[text()='Order Booking Logs Report']")).click();
			...
			Thread.sleep(5000);
			driver.findElement(By.xpath("//input[@id='exportArchivedOrders']")).click();
			Thread.sleep(5000);
			//Logout
            Thread.sleep(5000);
