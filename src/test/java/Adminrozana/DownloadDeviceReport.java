...
public class DownloadDeviceReport {
	@Test
	public void downloadDeviceReport() throws InterruptedException {
		 Logger logger = Logger.getLogger(DownloadDeviceReport.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[@href='https://dev.rozana.in/admin/devicereport']")).click();
