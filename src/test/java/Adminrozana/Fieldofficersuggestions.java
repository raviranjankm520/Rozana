...
public class Fieldofficersuggestions {
	@Test
	public void callmeback1() throws InterruptedException {
		 Logger logger = Logger.getLogger(Fieldofficersuggestions.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Fieldofficer Suggestions']")).click();
			driver.findElement(By.xpath("//a[text()='Fieldofficer Suggestions List']")).click();
