...
public class Peerpartnerordrangechange {
	@Test
	public void peerpartnerordrangechange() throws InterruptedException {
		 Logger logger = Logger.getLogger(Peerpartnerordrangechange.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li//a//span[text()='Partner Order Range']")).click();
			driver.findElement(By.xpath("//a[text()='Partner Order Range List']")).click();
			driver.findElement(By.xpath("//a[@rel='next']")).click();
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("Test_Data Rozana");
			driver.findElement(By.xpath("//input[@value='search']")).click();
			driver.findElement(By.xpath("//tr[1]//td[7]//a[@title='Want to Change? Click Here!']")).click();
			//driver.findElement(By.xpath("//tr[1]//td[7]//div//input[@name='min_range']")).clear();
			driver.findElement(By.xpath("//tr[1]//td[7]//div//input[@name='min_range']")).sendKeys("400");
			//driver.findElement(By.xpath("//tr[1]//td[7]//div//input[@name='max_range']")).clear();
			driver.findElement(By.xpath("//tr[1]//td[7]//div//input[@name='max_range']")).sendKeys("180000");
			//driver.findElement(By.xpath("//tr[1]//td[7]//div//input[@name='submit']")).click();
			driver.findElement(By.xpath("//tr[1]//td[7]//div//input[@name='reset']")).click();
			//Logout
            Thread.sleep(5000);
