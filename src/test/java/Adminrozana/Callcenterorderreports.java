...
public class Callcenterorderreports {
	@Test
	public void callcenterorderreports() throws InterruptedException {
		 Logger logger = Logger.getLogger(Callcenterorderreports.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a[text()='Call Center Order Reports']")).click();
			...
			driver.findElement(By.xpath("//input[@placeholder='Type name & hit Enter']")).sendKeys("Priyanka Delhi");
