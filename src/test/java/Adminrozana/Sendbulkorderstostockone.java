...
public class Sendbulkorderstostockone {
	@Test
	public void tobeapproved() throws InterruptedException {
		 Logger logger = Logger.getLogger(Tobeapproved.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li[8]//a//span[text()='Send Bulk Orders To Stockone ']")).click();
            driver.findElement(By.xpath("//button[text()='Download CSV']")).click();
            driver.findElement(By.xpath("//input[@name='bulk_file']")).sendKeys("C:\\Users\\Ravi Ranjan\\OneDrive\\Desktop\\Test data\\stockone_order_bulk_demo.xlsx");
