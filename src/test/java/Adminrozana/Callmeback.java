...
public class Callmeback {
	...
	public void callmeback() throws InterruptedException {
		 Logger logger = Logger.getLogger(Callmeback.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("(//ul//li//a//span[text()='Call Me Back'])[3]")).click();
			WebElement sorthinghub=driver.findElement(By.xpath("//select[@id='sorthinghub']"));
			Select select=new Select(sorthinghub);
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("raviranjan.km520@gmail.com");
			driver.findElement(By.xpath("//input[@type='submit']")).click();
			driver.findElement(By.xpath("//a[text()='Download']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[3]//td[1]//input[@type='checkbox']")).click();
			WebElement callcenteruser=driver.findElement(By.xpath("(//select[@class='form-control demo-select2'])[2]"));
			Select select1=new Select(callcenteruser);
			select1.selectByVisibleText("ravi");
			driver.findElement(By.xpath("//input[@value='submit']")).click();
			WebElement statusfromcallcenter=driver.findElement(By.xpath("(//select[@name='statusfromcallcenter'])[3]"));
			Select select2=new Select(statusfromcallcenter);
			select2.selectByVisibleText("Closed");
			//Logout
            Thread.sleep(5000);
