...
public class Sortinghublogin {
	@Test
	public void sortinghublogin() throws InterruptedException {
		 Logger logger = Logger.getLogger(Sortinghublogin.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[8]//ul//li[1]//a[text()='Log in as this Sorting Hub']")).click();
           //Logout
            Thread.sleep(5000);
