...
public class Festivalsgif {
	@Test
	public void festivalgif() throws InterruptedException {
		 Logger logger = Logger.getLogger(Festivalsgif.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Festivals GIF']")).click();
            driver.findElement(By.xpath("//a[@href='https://dev.rozana.in/admin/festivals']")).click();
            driver.findElement(By.xpath("//select[@name='type']")).click();
            driver.findElement(By.xpath("//option[@value='jpg']")).click();
            ...
            driver.findElement(By.xpath("(//a[@onclick='return confirmation()'])[1]")).click();
            driver.findElement(By.xpath("//a[@href='https://dev.rozana.in/admin/festivals']")).click();
            driver.findElement(By.xpath("(//a[@href='https://dev.rozana.in/admin/products/media'])[1]")).click();
            //Logout
            Thread.sleep(5000);
