...
public class Ordercancelledbycustomer {
	@Test
	public void ordercancelledbycustomer() throws InterruptedException {
		 Logger logger = Logger.getLogger(Ordercancelledbycustomer.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[text()='Order Cancelled By Customer']")).click();
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath("//input[@placeholder='Type Order code or name & hit Enter']")).sendKeys("ORD38283089887677C");
