...
public class Calllogs {
	...
	public void calllogs() throws InterruptedException {
		 Logger logger = Logger.getLogger(Calllogs.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Call Logs ']")).click();
			driver.findElement(By.xpath("//ul//li//a[text()='Download Center']")).click();
			WebElement callLogs=driver.findElement(By.xpath("//select[@aria-controls='callLogsArchiveTbl']"));
			Select select=new Select(callLogs);
			...
			driver.findElement(By.xpath("//input[@type='search']")).sendKeys("rahul@rozana.com");
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[8]//a//i[@class='fa fa-download']")).click();
