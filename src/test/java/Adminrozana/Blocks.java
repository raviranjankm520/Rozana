...
public class Blocks {
	@Test
	public void blocks() throws InterruptedException {
		 Logger logger = Logger.getLogger(Blocks.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Add New Block']")).click();
            WebElement state1=driver.findElement(By.xpath("//select[@id='state']"));
            Select select2=new Select(state1);
            select2.selectByVisibleText("Bihar");
            WebElement District1=driver.findElement(By.xpath("//select[@id='district']"));
            Select select3=new Select(District1);
            select3.selectByVisibleText("Vaishali");
            WebElement Pincode= driver.findElement(By.xpath("//select[@id='pincode']"));
            Select select4=new Select(Pincode);
            select4.selectByVisibleText("844116");
            driver.findElement(By.xpath("//input[@id='block_name']")).sendKeys("Rajapakar");
