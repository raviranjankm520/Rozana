...
public class Searchkey {
	...
	public void searchkey() throws InterruptedException {
		 Logger logger = Logger.getLogger(Searchkey.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Search Key']")).click();
			driver.findElement(By.xpath("//a[@rel='next']")).click();
			driver.findElement(By.xpath("//input[@id='date_from']")).clear();
			driver.findElement(By.xpath("//input[@id='date_from']")).sendKeys("07-12-2023");
			 Thread.sleep(5000);
			driver.findElement(By.xpath("//input[@id='date_to']")).clear();
            driver.findElement(By.xpath("//input[@id='date_to']")).sendKeys("13-02-0224");
