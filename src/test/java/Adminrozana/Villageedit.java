...
public class Villageedit {
	@Test
	public void villageedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Villageedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//tr[1]//td[4]//div//button[@type='button']")).click();
            driver.findElement(By.xpath("//tr[1]//td[4]//ul//li//a[text()='Edit']")).click();
            driver.findElement(By.xpath("//input[@name='village_name']")).clear();
            driver.findElement(By.xpath("//input[@name='village_name']")).sendKeys("Test");
            driver.findElement(By.xpath("//button[text()='Update Village']")).click();
