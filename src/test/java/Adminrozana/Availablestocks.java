...
public class Availablestocks {
	...
	public void stockreport() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[@href='https://dev.rozana.in/admin/products/stock']")).click();
			driver.findElement(By.xpath("//div//ul//li//a[@rel='next']")).click();
			WebElement sorting_id=driver.findElement(By.xpath("//select[@name='sorting_hub_id']"));
