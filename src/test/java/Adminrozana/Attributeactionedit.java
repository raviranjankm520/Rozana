...
public class Attributeactionedit {
	@Test
	public void attributeactionedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Attributeactionedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
        	...
        	driver.findElement(By.xpath("//table//tbody//tr[1]//td[4]//a[text()='Download Attribute Values']")).click();
            driver.findElement(By.xpath("//table//tr[1]//td[5]//div[@class='btn-group dropdown']")).click();
            driver.findElement(By.xpath("//table//tr[1]//td[5]//div//ul//li//a[text()='Edit']")).click();
            driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("1.5T");
