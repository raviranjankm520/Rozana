...
public class Ordercancelledbyadmin {
	@Test
	public void ordercancelledbyadmin() throws InterruptedException {
		 Logger logger = Logger.getLogger(Ordercancelledbyadmin.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//input[@placeholder='Type Order code or name & hit Enter']")).sendKeys("ORD46821226888494C");
