...
public class Peerpartnerview {
	@Test
	public void peerpartnerview() throws InterruptedException {
		 Logger logger = Logger.getLogger(Peerpartnerview.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//li//span[@class='dtr-data']//div//ul//li//a[text()='View']")).click();
            //Logout
