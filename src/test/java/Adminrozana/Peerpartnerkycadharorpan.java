...
public class Peerpartnerkycadharorpan {
	@Test
	public void peerpartnerkycadharorpan() throws InterruptedException {
		 Logger logger = Logger.getLogger(Peerpartnerlog.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[text()='Peer Partner KYC Adhar / Pan']")).click();
			...
			driver.findElement(By.xpath("//input[@placeholder='Type name or email & hit Enter']")).sendKeys("499001@xyz.com");
