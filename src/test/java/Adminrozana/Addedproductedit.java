...
public class Addedproductedit {
	@Test
	public void addedproductedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Addedproductedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//input[@name='name']")).sendKeys("Testing product");
           ...
           driver.findElement(By.xpath("//input[@name='meta_title']")).sendKeys("testing");
           driver.findElement(By.xpath("//textarea[@name='meta_description']")).clear();
			driver.findElement(By.xpath("//textarea[@name='meta_description']")).sendKeys("Testing Purpose Product");
