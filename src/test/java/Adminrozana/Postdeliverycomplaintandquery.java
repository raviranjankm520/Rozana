...
public class Postdeliverycomplaintandquery {
	@Test
	public void postdeliverycomplaintandquery() throws InterruptedException {
		 Logger logger = Logger.getLogger(Postdeliverycomplaintandquery.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Post Delivery Complaint & Query']")).click();
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("CTN933921");
			...
			WebElement callcenter_status=driver.findElement(By.xpath("//table//tbody//tr[1]//td[2]//select[@name='callcenter_status']"));
			Select select1=new Select(callcenter_status);
			select1.selectByVisibleText("Closed");
			driver.findElement(By.xpath("//input[@placeholder='Write something']")).sendKeys("");
