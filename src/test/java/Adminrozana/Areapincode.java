...
public class Areapincode {
	...
	public void areapincode() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Add New Pincode']")).click();
            ...
            select3.selectByVisibleText("Muzaffarpur");
            WebElement Uploadfile=driver.findElement(By.xpath("//input[@id='upload_file']"));
            Uploadfile.sendKeys("C:\\Users\\Ravi Ranjan\\OneDrive\\Desktop\\Test data\\pin-codes-samlple-file.xlsx");
