...
public class Peerpartnerlog {
	@Test
	public void peerpartnerlog() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[text()='Peer Partner']")).click();
			...
			driver.findElement(By.xpath("//input[@placeholder='Type name or email & hit Enter']")).sendKeys("up168807@gmail.com");
