...
public class PayoutRequestsLogs {
	@Test
	public void payoutRequestsLogs() throws InterruptedException {
		 Logger logger = Logger.getLogger(PayoutRequestsLogs.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			//Payout Requests
			driver.findElement(By.xpath("(//span[text()='Payout Requests'])[2]")).click();
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath("//input[@placeholder='Type name or email']")).sendKeys("shubhampatel4505@gmail.com");
