...
public class Brandedit {
	...
	public void brandedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Brandedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("Test Product1");
			...
			driver.findElement(By.xpath("//input[@name='meta_title']")).sendKeys("Test2");
			driver.findElement(By.xpath("//textarea[@name='meta_description']")).sendKeys("Test Purpose123");
