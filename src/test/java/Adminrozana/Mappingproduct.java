...
public class Mappingproduct {
	@Test
	public void mappingproduct() throws InterruptedException {
		 Logger logger = Logger.getLogger(Mappingproduct.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Mapping Product']")).click();
            driver.findElement(By.xpath("(//a[@href='https://dev.rozana.in/admin/products/mapping_products?page=2'])[1]")).click();
