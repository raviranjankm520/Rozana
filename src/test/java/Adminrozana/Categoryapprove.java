...
public class Categoryapprove {
	@Test
	public void categoryapprove() throws InterruptedException {
		 Logger logger = Logger.getLogger(Categoryapprove.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("Test category");
			driver.findElement(By.xpath("//input[@value='search']")).click();
			driver.findElement(By.xpath("//table//tr[1]//td[5]//span[@class='slider round']")).click();
			driver.findElement(By.xpath("//table//tr[1]//td[6]//span[@class='slider round']")).click();
			driver.findElement(By.xpath("//table//tr[1]//td[8]//span[@class='slider round']")).click();
			// LogOut
			  Thread.sleep(5000); 
