...
public class Alternateaddressesrequest {
	@Test
	public void alternateaddressesrequest() throws InterruptedException {
		 Logger logger = Logger.getLogger(Alternateaddressesrequest.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Alternate Addresses Request']")).click();
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("1236547899");
			driver.findElement(By.xpath("//input[@value='search']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[7]//span[@class='slider round']")).click();
			//Logout
	          Thread.sleep(5000);
