...
public class Dashboard {
	...
	public void dashboard() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			List<WebElement> rowPanel= driver.findElements(By.xpath(".//div[@id='page-content']/div[@class='row']"));
			
			for( WebElement row : rowPanel ) {
				Dimension dimesions = row.getSize();
				js.executeScript("window.scrollBy(0,"+ dimesions.height +")");
				Thread.sleep(2000);
			}
