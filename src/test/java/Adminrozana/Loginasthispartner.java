...
public class Loginasthispartner {
	@Test
	public void loginasthispartner() throws InterruptedException {
		 Logger logger = Logger.getLogger(Loginasthispartner.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul[@class='dtr-details']//ul[@class='dropdown-menu dropdown-menu-right']//li[4]")).click();
