...
public class Notifyme {
	...
	public void notifyme() throws InterruptedException {
		 Logger logger = Logger.getLogger(Notifyme.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Notify Me']")).click();
			driver.findElement(By.xpath("//a[@rel='next']")).click();
			driver.findElement(By.xpath("//input[@placeholder='Type Name Email & Phone ']")).sendKeys("6306839605");
