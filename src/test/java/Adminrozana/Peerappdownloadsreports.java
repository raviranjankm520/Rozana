...
public class Peerappdownloadsreports {
	@Test
	public void peerappdownloadsreports() throws InterruptedException {
		 Logger logger = Logger.getLogger(Peerappdownloadsreports.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a[text()='Peer App Downloads Reports']")).click();
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("raviranja.km520@gmail.com");
