...
public class Orderedit {
	...
	public void orderedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Orderedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[text()='Order Edit']")).click();
			Thread.sleep(2000);
			...
			driver.findElement(By.xpath("//input[@placeholder='Type Order code or name & hit Enter']")).sendKeys("ORD59356947604269C");
