...
public class Createsubadminuserdeletepos {
	@Test
	public void createsubadminusereditpos() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
	        ...
	        driver.findElement(By.xpath("//tr[1]//td[10]//ul//li[2]")).click();
	        driver.findElement(By.xpath("//div[@class='modal-footer']//a[@id='delete_link']")).click();
	      //Logout
	        Thread.sleep(5000);
