...
public class Cancelorderreason {
	...
	public void inventorymodule() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Cancel Order Reason']")).click();
			driver.findElement(By.xpath("//a[text()='Add New Reason']")).click();
			driver.findElement(By.xpath("//textarea[@name='reason']")).sendKeys("Test");
			//driver.findElement(By.xpath("(//button[text()='Cancel'])[1]")).click();
			driver.findElement(By.xpath("//button[text()='Save']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[11]//td//label//span[@class='slider round']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[11]//td//button[@type='button']")).clear();
			driver.findElement(By.xpath("//table//tbody//tr[11]//td//ul//li//a[text()='Edit']")).click();
			driver.findElement(By.xpath("//textarea[@name='reason']")).clear();
			driver.findElement(By.xpath("//textarea[@name='reason']")).sendKeys("Test");
			//driver.findElement(By.xpath("(//button[text()='Cancel'])[1]")).click();
			driver.findElement(By.xpath("//button[text()='Save']")).click();
			//Logout
