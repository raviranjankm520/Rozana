...
public class Orderfunnelreport {
	@Test
	public void orderfunnelreport() throws InterruptedException {
		 Logger logger = Logger.getLogger(Orderfunnelreport.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a[text()='Order Funnel report']")).click();
			driver.findElement(By.xpath("//a[text()='Download Funnel Report']")).click();
			...
			driver.findElement(By.xpath("//div[@id='reportrangenew']")).click();
			driver.findElement(By.xpath("(//div[@class='ranges']//ul//li[text()='Last 3 Days'])[2]")).click();
			WebElement  sortingHubs=driver.findElement(By.xpath("//select[@name='sortingHubs']"));
			Select select=new Select(sortingHubs);
