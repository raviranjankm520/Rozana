...
public class ManageOrders {
	...
	public void manageOrders() throws InterruptedException, AWTException {
		...
		WebDriver driver = new ChromeDriver();
            ...
            WebElement sorting_hub=driver.findElement(By.xpath("//select[@id='sorting_hub_id']"));
            Select select=new Select(sorting_hub);
            select.selectByVisibleText("Barabanki - Nindoora SH");
            ...
            driver.findElement(By.xpath("//input[@id='search']")).sendKeys("ORD67069087830873");
            driver.findElement(By.xpath("//button[@type='submit']")).click();
            ...
            driver.findElement(By.xpath("//a[text()='Export Assigned Orders']")).click();
           ...
           // Thread.sleep(5000);
           // driver.findElement(By.xpath("//a[text()='Export Shipsy Order']")).click();
            Thread.sleep(5000);
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[12]//div//button[@type='button']")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[12]//div//ul//li[2]//a[text()='Full Invoice Print']")).click();            		
            Thread.sleep(2000);
            driver.findElement(By.xpath("(//button[@class='close'])[2]")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[12]//div//button[@type='button']")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[12]//div//ul//li[1]//a[text()='View']")).click();
