...
public class Customreferralcodechange {
	@Test
	public void customreferralcodechange() throws InterruptedException {
		 Logger logger = Logger.getLogger(Customreferralcodechange.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			// Peer Partner Log
			driver.findElement(By.xpath("//span[text()='Peer Partner Log']")).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[text()='Custom Referral Code Change']")).click();
			...
			driver.findElement(By.xpath("//input[@placeholder='Type name or email & hit Enter']")).sendKeys("98P@gmail.com");
