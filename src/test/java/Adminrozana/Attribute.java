...
public class Attribute {
	...
	public void attribute() throws InterruptedException {
		 Logger logger = Logger.getLogger(Attribute.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[@href='https://dev.rozana.in/admin/attributes/create']")).click();
            driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Test1");
            driver.findElement(By.xpath("//button[@class='btn btn-purple']")).click();
            driver.findElement(By.xpath("//a[@style='margin-left: 10px;']")).click();
    	 //Logout
   Thread.sleep(5000);
