...
public class PayoutRequests {
	@Test
	public void payoutRequests() throws InterruptedException {
		 Logger logger = Logger.getLogger(PayoutRequests.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li//a//span[text()='Payout Requests']")).click();
          //Logout
            Thread.sleep(5000);
