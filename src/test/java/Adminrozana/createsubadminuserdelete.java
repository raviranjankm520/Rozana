...
public class createsubadminuserdelete {
	@Test
	public void Createsubadminuserdelete() throws InterruptedException {
		 Logger logger = Logger.getLogger(createsubadminuserdelete.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[@rel='next']")).click();
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("ravicalltest@gmail.com");
			driver.findElement(By.xpath("//input[@type='submit']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[9]")).click();
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[10]//button[@type='button']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[10]//ul//li//a[text()='Delete']")).click();
			Thread.sleep(1000);
