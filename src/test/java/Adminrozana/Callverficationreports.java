...
public class Callverficationreports {
	@Test
	public void logsreports() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a//span[text()='Call Verfication Reports']")).click();
			driver.findElement(By.xpath("//ul//li//a//span[text()='Call Verification']")).click();
