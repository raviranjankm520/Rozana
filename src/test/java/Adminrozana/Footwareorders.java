...
public class Footwareorders {
	@Test
	public void footwareorders() throws InterruptedException {
		 Logger logger = Logger.getLogger(Footwareorders.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Footware Orders']")).click();
            ...
            WebElement shipsy_status=driver.findElement(By.xpath("//select[@id='shipsy_status']"));
            Select select=new Select(shipsy_status);
            select.selectByVisibleText("Pending");
            WebElement stockone_status=driver.findElement(By.xpath("//select[@id='stockone_status']"));
            Select select0=new Select(stockone_status);
            select0.selectByVisibleText("Pending");
			...
			driver.findElement(By.xpath("(//table//tbody//tr//td[text()='30'])[3]")).click();
