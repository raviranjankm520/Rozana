...
public class Fieldofficerattendance {
	@Test
	public void fieldofficerattendance() throws InterruptedException {
		 Logger logger = Logger.getLogger(Fieldofficerattendance.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Fieldofficer Attendance']")).click();
			WebElement option=driver.findElement(By.xpath("//select[@class='form-control input-sm']"));
			Select select=new Select(option);
			select.selectByVisibleText("25");
			driver.findElement(By.xpath("//a//span[text()='Excel']")).click();
			driver.findElement(By.xpath("//input[@type='search']")).sendKeys("AAYUSH MISHRA_Foot_Pratapgarh");
			driver.findElement(By.xpath("(//div//table//thead//tr//th[1])[2]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("(//div//table//thead//tr//th[2])[2]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("(//div//table//thead//tr//th[3])[2]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("(//div//table//thead//tr//th[4])[2]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("(//div//table//thead//tr//th[5])[2]")).click();
			Thread.sleep(1000);
			driver.findElement(By.xpath("(//div//table//thead//tr//th[6])[1]")).click();
			Thread.sleep(1000);
            driver.findElement(By.xpath("(//div//table//thead//tr//th[7])[1]")).click();
			//Logout
            Thread.sleep(5000);
