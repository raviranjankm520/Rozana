...
public class PeerFochange {
	@Test
	public void peerFochange() throws InterruptedException {
		 Logger logger = Logger.getLogger(PeerFochange.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li//a//span[text()='Peer FO change']")).click();
            driver.findElement(By.xpath("//a[@rel='next']")).click();
            driver.findElement(By.xpath("//input[@name='search']")).sendKeys("raviranjan.km520@gmail.com");
            driver.findElement(By.xpath("//input[@type='submit']")).click();
            driver.findElement(By.xpath("//table//tr[1]//td[6]//button[@class='btn btn-primary changeFO']")).click();
            WebElement fo=driver.findElement(By.xpath("//div//select[@id='approved_id']"));
            Select select=new Select(fo);
