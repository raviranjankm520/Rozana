...
public class Bestsellingproducts {
	@Test
	public void bestsellingproducts() throws InterruptedException {
		 Logger logger = Logger.getLogger(Bestsellingproducts.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Best Selling Products']")).click();
          //Logout
            Thread.sleep(5000);
