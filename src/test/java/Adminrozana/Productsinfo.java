...
public class Productsinfo {
	@Test
	public void ProductsInfo() throws InterruptedException {
		 Logger logger = Logger.getLogger(Productsinfo.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li[5]//a//span[text()='Products Info']")).click();
            ...
            driver.findElement(By.xpath("//input[@placeholder='Type Child Sku and Invoice Number  ']")).sendKeys("UP02IN24/88242");
