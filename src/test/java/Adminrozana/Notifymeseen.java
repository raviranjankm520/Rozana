...
public class Notifymeseen {
	@Test
	public void notifymeseen() throws InterruptedException {
		 Logger logger = Logger.getLogger(Notifymeseen.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Notification Seen']")).click();
			driver.findElement(By.xpath("//ul//li//a[text()='Notify Me Seen']")).click();
			driver.findElement(By.xpath("//a[@rel='next']")).click();
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("9795703286");
