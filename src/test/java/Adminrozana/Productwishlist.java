...
public class Productwishlist {
	...
	public void inhousesalereport() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Product Wishlist']")).click();
			...
			driver.findElement(By.xpath("//input[@type='search']")).sendKeys("Appy Fizz - Rs 10");
			driver.findElement(By.xpath("//div//nav//ul//li//a[@rel='next']")).click();
