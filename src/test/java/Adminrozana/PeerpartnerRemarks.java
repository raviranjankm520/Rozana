...
public class PeerpartnerRemarks {
	@Test
	public void peerpartnerRemarks() throws InterruptedException {
		 Logger logger = Logger.getLogger(PeerpartnerRemarks.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            Thread.sleep(5000);
            driver.findElement(By.xpath("//tr[@class='child']//ul[@class='dtr-details']//li[8]//span[@class='dtr-data']//button[text()='Remarks']")).click();
