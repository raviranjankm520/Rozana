...
public class Clusterwisestaffupload {
	@Test
	public void clusterwisestaffupload() throws InterruptedException {
		 Logger logger = Logger.getLogger(Clusterwisestaffupload.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(500);
            driver.findElement(By.xpath("(//span[@class=\"menu-title\"])[6]")).click();
            driver.findElement(By.xpath("//a[text()='Download Demo File']")).click();
            driver.findElement(By.xpath("//input[@type='file']")).sendKeys("C:\\Users\\Ravi Ranjan\\OneDrive\\Desktop\\Test data\\staff-clusterwise.csv");
