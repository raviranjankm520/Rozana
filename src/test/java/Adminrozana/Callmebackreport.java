...
public class Callmebackreport {
	@Test
	public void callmebackreport() throws InterruptedException {
		 Logger logger = Logger.getLogger(Callmebackreport.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a//span[text()='Call Me Back']")).click();
			driver.findElement(By.xpath("(//ul//li//a//span[text()='Call Me Back'])[2]")).click();
			...
			Thread.sleep(5000);
			driver.findElement(By.xpath("//input[@id='exportCallMeBack']")).click();
			//Logout
            Thread.sleep(5000);
