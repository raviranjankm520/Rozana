...
public class Bancustomer {
	...
	public void bancustomer() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("(//table//tr[1]//td[8]//ul//li//a[@href='#'])[2]")).click();
			//driver.findElement(By.xpath("//div[@class='modal-footer']//button[@id='refreshButton']"));
			driver.findElement(By.xpath("//div//a[@id='confirmation']")).click();
			//Logout
            Thread.sleep(5000);
