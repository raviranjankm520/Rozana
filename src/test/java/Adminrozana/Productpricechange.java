...
public class Productpricechange {
	@Test
	public void productpricechange() throws InterruptedException {
		 Logger logger = Logger.getLogger(Productpricechange.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//span[text()='Product price change']")).click();
			Thread.sleep(2000);
			...
			WebElement sorting_hub_id=driver.findElement(By.xpath("//select[@name='sorting_hub_id']"));
			Select select=new Select(sorting_hub_id);
			select.selectByVisibleText("Raebareli Sorting Hub");
			driver.findElement(By.xpath("//input[@placeholder='Type Name']")).sendKeys("Relaxo Cushion 16 - Size 6 to 10 - Slipper For Mens (Pack of 6 Pairs)");
