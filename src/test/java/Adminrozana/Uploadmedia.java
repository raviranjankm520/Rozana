...
public class Uploadmedia {
	...
	public void uploadmedia() throws InterruptedException {
		 Logger logger = Logger.getLogger(Uploadmedia.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Upload Media']")).click();
            ...
            uploadfile.sendKeys("C:\\Users\\Ravi Ranjan\\OneDrive\\Documents\\imagefoot.jpg");
