...
public class Callerdeskbulkupload {
	@Test
	public void callerdeskbulkupload() throws InterruptedException {
		 Logger logger = Logger.getLogger(Callerdeskbulkupload.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Caller Desk Bulk Upload']")).click();
			...
			uploadfile.sendKeys("C:\\Users\\Ravi Ranjan\\OneDrive\\Desktop\\Test data\\call_logs_bulk_demo.xlsx");
