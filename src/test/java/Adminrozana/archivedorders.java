...
public class archivedorders {
	...
	public void postshipsyorders() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li//a//span[text()='Archived Orders ']")).click();
            ...
            driver.findElement(By.xpath("(//table//tbody//tr//td[text()='11'])[1]")).click();
            driver.findElement(By.xpath("//button[text()='Apply']")).click();
            //driver.findElement(By.xpath("(//button[text()='Cancel'])[3]")).click();
            driver.findElement(By.xpath("//input[@placeholder='Type Order code or name & hit Enter']")).sendKeys("ORD59430082369168");
