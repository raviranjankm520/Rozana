...
public class Subsubcategoryedit {
	@Test
	public void subsubcategoryedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Subsubcategoryedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Test sub subcategory");
