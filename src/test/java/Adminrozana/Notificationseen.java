...
public class Notificationseen {
	@Test
	public void notificationseen() throws InterruptedException {
		 Logger logger = Logger.getLogger(Notificationseen.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Push Notification Seen']")).click();
