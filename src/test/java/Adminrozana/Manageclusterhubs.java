...
public class Manageclusterhubs {
	@Test
	public void manageclusterhubs() throws InterruptedException {
		 Logger logger = Logger.getLogger(Manageclusterhubs.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Add New Cluster']")).click();
