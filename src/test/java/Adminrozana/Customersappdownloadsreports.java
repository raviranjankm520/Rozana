...
public class Customersappdownloadsreports {
	@Test
	public void customersappdownloadsreports() throws InterruptedException {
		 Logger logger = Logger.getLogger(Customersappdownloadsreports.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(1000);
			driver.findElement(By.xpath("//ul//li//a[text()='Customers App Downloads Reports']")).click();
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("Abhay Gupta");
			driver.findElement(By.xpath("//input[@value='search']")).click();
			driver.findElement(By.xpath("//a[text()='Download Reports']")).click();
