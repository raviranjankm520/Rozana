...
public class unbancustomer {
	@Test
	public void bancustomer() throws InterruptedException {
		 Logger logger = Logger.getLogger(Bancustomer.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Customer list']")).click();
			driver.findElement(By.xpath("//a[@rel='next']")).click();
			WebElement sort_customers=driver.findElement(By.xpath("//select[@onchange='sort_customers()']"));
			Select select=new Select(sort_customers);
			select.selectByVisibleText("Peer Not Assigned");
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("testes@gmail.com");
			driver.findElement(By.xpath("//input[@type='submit']")).click();
			driver.findElement(By.xpath("//table//tr[1]//td[8]//button[@type='button']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[8]//ul//li//a[@href='#']")).click();
			Thread.sleep(2000);
			driver.findElement(By.xpath("(//div//a[text()='Proceed!'])[1]")).click();
			//driver.findElement(By.xpath("(//div//button[@class='btn btn-default'])[4]")).click();
