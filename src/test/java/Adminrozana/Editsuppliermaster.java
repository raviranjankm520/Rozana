...
public class Editsuppliermaster {
	@Test
	public void editsuppliermaster() throws InterruptedException {
		 Logger logger = Logger.getLogger(Editsuppliermaster.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//table//tr[1]//td[@tabindex='0']")).click();
            driver.findElement(By.xpath("//tr[@class='child']//ul[@class='dtr-details']//li[4]//span[@class='dtr-data']//button[@data-toggle='dropdown']")).click();
            ...
            driver.findElement(By.xpath("//input[@name='gstinno']")).clear();
            driver.findElement(By.xpath("//input[@name='gstinno']")).sendKeys("09AAECF1722F1ZY");
            driver.findElement(By.xpath("//input[@id='panNumber']")).clear();
            driver.findElement(By.xpath("//input[@id='panNumber']")).sendKeys("BFGYU5678C");
            driver.findElement(By.xpath("//input[@name='supplier_contact_name']")).clear();
            driver.findElement(By.xpath("//input[@name='supplier_contact_name']")).sendKeys("Ravi");
            driver.findElement(By.xpath("//input[@name='supplier_contact_phone']")).clear();
            driver.findElement(By.xpath("//input[@name='supplier_contact_phone']")).sendKeys("9608434452");
            driver.findElement(By.xpath("//input[@name='supplier_contact_email']")).clear();
            ...
            driver.findElement(By.xpath("//input[@name='secondary_email']")).clear();
            ...
            driver.findElement(By.xpath("//input[@name='file']")).clear();
            ...
            driver.findElement(By.xpath("//button[text()='Update Supplier']")).click();
            driver.findElement(By.xpath("//table//tr[1]//td[@tabindex='0']")).click();
            driver.findElement(By.xpath("//tr[@class='child']//ul[@class='dtr-details']//li[4]//span[@class='dtr-data']//button[@data-toggle='dropdown']")).click();
            driver.findElement(By.xpath("//li//span[@class='dtr-data']//div//ul//li//a[text()='Add To Stockone']")).click();
            //Logout
          Thread.sleep(5000);
