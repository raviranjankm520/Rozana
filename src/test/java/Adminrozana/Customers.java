...
public class Customers {
	...
	public void customers() throws InterruptedException {
		 Logger logger = Logger.getLogger(Customers.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("ravi.sabhi123@gmail.com");
			...
			driver.findElement(By.xpath("(//table//tr[1]//td[8]//ul//li//a[@href='#'])[1]")).click();
			//driver.findElement(By.xpath("(//div[@class='modal-footer']//button[@class='btn btn-default'])[5]")).click();
			//driver.findElement(By.xpath("//div[@class='modal-footer']//a[@id='confirmation_partner']")).click();
