...
public class Tobeapproved {
	...
	public void tobeapproved() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li[6]//a//span[text()='To Be Approved ']")).click();
            driver.findElement(By.xpath("//a[@rel='next']")).click();
            driver.findElement(By.xpath("//a[text()='To Be Approved ']")).click();
            driver.findElement(By.xpath("//div[@id='reportrange']")).click();
            driver.findElement(By.xpath("//div[@class='ranges']//ul//li[text()='Today']")).click();
