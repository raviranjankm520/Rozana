...
public class Sortinghubedit {
	...
	public void managesortinghub() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//input[@placeholder='Type name & Email']")).sendKeys("ramtesttest@rozana.com");
            driver.findElement(By.xpath("//input[@value='search']")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[8]//div[@class='btn-group dropdown']")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[8]//ul//li[2]//a[text()='Edit']")).click();
            Thread.sleep(2000);
            ...
            driver.findElement(By.xpath("//textarea[@name='address']")).sendKeys("Dariyapur Chauraha, MunshiGanj, Karnataka");
