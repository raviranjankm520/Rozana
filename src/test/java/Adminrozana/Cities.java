...
public class Cities {
	...
	public void cities() throws InterruptedException {
		 Logger logger = Logger.getLogger(Cities.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//input[@placeholder='Type name & Enter']")).sendKeys("Aurangabad");
            driver.findElement(By.xpath("//input[@type='submit']")).click();
            driver.findElement(By.xpath("//a[text()='Add New City']")).click();
            ...
            driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Purnia");
