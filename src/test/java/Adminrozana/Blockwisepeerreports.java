...
public class Blockwisepeerreports {
	@Test
	public void blockwisepeerreports() throws InterruptedException {
		 Logger logger = Logger.getLogger(Blockwisepeerreports.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//input[@onclick='sort(0)']")).click();
			WebElement sorting_hub=driver.findElement(By.xpath("//select[@id='sorting_hub']"));
			Select select1=new Select(sorting_hub);
			select1.selectByVisibleText("Raebareli Sorting Hub");
