...
public class Returnverificationrequest {
	@Test
	public void returnverificationrequest() throws InterruptedException {
		 Logger logger = Logger.getLogger(Returnverificationrequest.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a//span[text()='Return Verification Request']")).click();
			driver.findElement(By.xpath("//ul//li//a[@rel='next']")).click();
            driver.findElement(By.xpath("//input[@id='search']")).sendKeys("ORD99102647116426");
