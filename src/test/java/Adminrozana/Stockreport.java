...
public class Stockreport {
	...
	public void stockreport() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Stock Report']")).click();
			...
			select.selectByVisibleText("Rural Lucknow");
			WebElement category_id =driver.findElement(By.xpath("//select[@name='category_id']"));
			Select select0=new Select(category_id );
			select0.selectByVisibleText("Personal Care");
			driver.findElement(By.xpath("//button[text()='Filter']")).click();
			WebElement  entries=driver.findElement(By.xpath("//select[@class='form-control input-sm']"));
			Select select1=new Select(entries);
			select1.selectByVisibleText("50");
			driver.findElement(By.xpath("//a//span[text()='Excel']")).click();
			driver.findElement(By.xpath("//a//span[text()='CSV']")).click();
			driver.findElement(By.xpath("//input[@type='search']")).sendKeys("ROZ2821-1Pcs");
			//Logout
            Thread.sleep(5000);
