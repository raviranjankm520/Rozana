...
public class Productstockchange {
	@Test
	public void productstockchange() throws InterruptedException {
		 Logger logger = Logger.getLogger(Productstockchange.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//span[text()='Product stock change']")).click();
			driver.findElement(By.xpath("//input[@placeholder='Type Name Or Sku']")).sendKeys("Relaxo Cushion 16 - Size 6 to 10 - Slipper For Mens (Pack of 6 Pairs)");
