...
public class CommunityVolunteer {
	@Test
	public void communityVolunteer() throws InterruptedException {
		 Logger logger = Logger.getLogger(CommunityVolunteer.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//a[text()='Add New Community Volunteer']")).click();
			driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Ravi");
			driver.findElement(By.xpath("//input[@id='email']")).sendKeys("Ravip@gmail.com");
			driver.findElement(By.xpath("//input[@id='mobile']")).sendKeys("8080808090");
			WebElement role_id=driver.findElement(By.xpath("//select[@name='role_id']"));
			Select select=new Select(role_id);
			select.selectByVisibleText("Community Volunteer");
			...
			select2.selectByVisibleText("Ayodhya");
			WebElement block=driver.findElement(By.xpath("//select[@id='block_id']"));
			Select select3=new Select(block);
			select3.selectByVisibleText("Mawai");
			WebElement Panchayats=driver.findElement(By.xpath("//select[@id='panchayat_id']"));
			Select select4=new Select(Panchayats);
			select4.selectByVisibleText("Umapur");
			WebElement cluster_id=driver.findElement(By.xpath("//select[@id='cluster_id']"));
			Select select5=new Select(cluster_id);
