...
public class Stockinventoryupdatelist {
	@Test
	public void stockinventoryupdatelist() throws InterruptedException {
		 Logger logger = Logger.getLogger(Stockinventoryupdatelist.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//ul//li//a[text()='Stock Inventory Update List']")).click();
			driver.findElement(By.xpath("//nav//ul//li//a[@rel='next']")).click();
			driver.findElement(By.xpath("//input[@id='search']")).sendKeys("Aashirvaad Shudh Chakki Atta - 10 Kg");
