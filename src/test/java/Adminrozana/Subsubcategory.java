...
public class Subsubcategory {
	@Test
	public void subsubcategory() throws InterruptedException {
		 Logger logger = Logger.getLogger(Subsubcategory.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Sub Subcategory']")).click();
            driver.findElement(By.xpath("//a[@rel='next']")).click();
            driver.findElement(By.xpath("//input[@type='text']")).sendKeys("Rehman");
            driver.findElement(By.xpath("//input[@value='search']")).click();
            driver.findElement(By.xpath("//a[@class='btn btn-rounded btn-info pull-right']")).click();
            //driver.findElement(By.xpath("//input[@placeholder='Name']")).sendKeys("Test sub subcategory");
            //driver.findElement(By.xpath("//b[@role='presentation']")).click();
    		//driver.findElement(By.xpath("//ul[@class='select2-results__options']/li[30]")).click();
    		//driver.findElement(By.xpath("//b[@role='presentation']")).click();
    		//driver.findElement(By.xpath("//ul[@class='select2-results__options']/li[17]")).click();
    		//driver.findElement(By.xpath("//input[@name='meta_title']")).sendKeys("Test");
    		driver.findElement(By.xpath("//textarea[@class='form-control']")).sendKeys("Testing data");
