...
public class Citiesedit {
	@Test
	public void citiesedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Citiesedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//ul//li//a//span[text()='Cities']")).click();
            ...
            driver.findElement(By.xpath("//input[@placeholder='Type name & Enter']")).sendKeys("Hajipur");
            driver.findElement(By.xpath("//input[@type='submit']")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[4]//div[@class='btn-group dropdown']")).click();
            driver.findElement(By.xpath("//table//tbody//tr[1]//td[4]//ul//li//a[text()='Edit']")).click();
            WebElement State1=driver.findElement(By.xpath("//select[@name='state']"));
            Select select1=new Select(State1);
            select1.selectByVisibleText("Bihar");
            driver.findElement(By.xpath("//input[@id='name']")).clear();
            driver.findElement(By.xpath("//input[@id='name']")).sendKeys("Vaishali");
