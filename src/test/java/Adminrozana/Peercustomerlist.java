...
public class Peercustomerlist {
	@Test
	public void peercustomerlist() throws InterruptedException {
		 Logger logger = Logger.getLogger(Peercustomerlist.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//input[@name='search']")).sendKeys("Jitendra Agrahari");
			driver.findElement(By.xpath("//button[@type='submit']")).click();
			driver.findElement(By.xpath("//a[text()='Export Peer List']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[1]//td[@tabindex='0']")).click();
			driver.findElement(By.xpath("//table//tbody//tr[2]//td//ul//li//span//a[text()='Export Customer Details']")).click();
