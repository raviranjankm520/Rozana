...
public class Categoryedit {
	...
	public void categoryedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Categoryedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//table//tr[1]//td[9]//div[@class='btn-group dropdown']")).click();
			driver.findElement(By.xpath("//table//tr[1]//td[9]//div//ul//li//a[text()='Edit']")).click();
			...
			driver.findElement(By.xpath("//table//tr[1]//td[10]//button[@class='btn btn-primary dropdown-toggle dropdown-toggle-icon']")).click();
			// LogOut
			  Thread.sleep(5000); 
