...
public class ApproveorDisapprove {
	@Test
	public void approveorDisapprove() throws InterruptedException {
		 Logger logger = Logger.getLogger(ApproveorDisapprove.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			Thread.sleep(2000);
			driver.findElement(By.xpath("//a[text()='Approve / Diapprove']")).click();
