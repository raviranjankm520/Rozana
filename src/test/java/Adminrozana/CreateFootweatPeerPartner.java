...
public class CreateFootweatPeerPartner {
	@Test
	public void createPartner() throws InterruptedException {
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//h3//div[@class='box-inline pad-rgt pull-right']//input[@value='partner_b2b']")).click();
            WebElement category=driver.findElement(By.xpath("//select[@id='categorySelect']"));
            Select select0=new Select(category);
            select0.selectByVisibleText("Footwears");
            driver.findElement(By.xpath("//input[@name='name']")).sendKeys("Ravi Ranjan");
            driver.findElement(By.xpath("//input[@name='phone']")).sendKeys("8878787800");
            driver.findElement(By.xpath("//input[@name='email']")).sendKeys("ravi125@gmail.com");
