...
public class Attributeedit {
	@Test
	public void attributeedit() throws InterruptedException {
		 Logger logger = Logger.getLogger(Attributeedit.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
            ...
            driver.findElement(By.xpath("//a[text()='Attribute']")).click();
            driver.findElement(By.xpath("//a[@data-dt-idx='6']")).click();
            driver.findElement(By.xpath("//input[@type='search']")).sendKeys("Testing Attribute");
          	driver.findElement(By.xpath("//table//tbody//tr[1]//td[3]//a[text()='Manage Values']")).click();
          	driver.findElement(By.xpath("//input[@placeholder='Please enter option value']")).sendKeys("1.5T+");
          	driver.findElement(By.xpath("//button[@type='submit']")).click();
          	driver.findElement(By.xpath("//table//tbody//tr[1]//td[3]//button[@class='btn btn-primary dropdown-toggle dropdown-toggle-icon']")).click();
          	driver.findElement(By.xpath("//table//tbody//tr[1]//td[3]//ul//li//a[text()='Edit']")).click();
