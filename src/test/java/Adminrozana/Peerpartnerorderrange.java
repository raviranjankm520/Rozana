...
public class Peerpartnerorderrange {
	@Test
	public void peerpartnerorderrange() throws InterruptedException {
		 Logger logger = Logger.getLogger(Peerpartnerorderrange.class.getName());
		// set the path of
		...
		WebDriver driver = new ChromeDriver();
			...
			driver.findElement(By.xpath("//a[text()='Bulk Range Upload']")).click();
			driver.findElement(By.xpath("//a//button[text()='Download CSV']")).click();
			driver.findElement(By.xpath("//input[@name='bulk_file']")).sendKeys("C:\\Users\\Ravi Ranjan\\OneDrive\\Desktop\\Test data\\peer_range_bulk_demo.xlsx");
